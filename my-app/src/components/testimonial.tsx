  ...
  const testimonials = [
    {
      ...
      quote:
        "The courses are top-notch, providing practical insights into the world of software development. The mentorship from industry experts has been invaluable. Thanks, I've not only upgraded my skills but also secured a rewarding position in a tech firm. Highly recommended!",
    },
    {
      ...
      quote:
        "The courses are well-structured, and the personalized guidance I received during mentorship sessions was beyond my expectations. The platform allowed me to create a stunning work profile, which played a pivotal role in landing my dream job. Thank you for shaping my digital marketing journey!",
    },
    {
      ...
      quote:
        " The diverse range of courses allowed me to explore different tech skills, and the career advisory services provided clarity on my professional path. The job placement assistance was the final push I needed. Today, I am thriving in a role that aligns perfectly with my aspirations. ",
    },
  ];
            ...
            <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {testimonials.map((item, idx) => (
                <li key={idx} className="bg-white rounded-xl border shadow-md">
                  ...
                  <figure>
                    <blockquote>
                      <p className="text-gray-800 text-justify text-lg font-semibold px-4 py-1">
                        {item.quote}
                      </p>
                    </blockquote>
